//
// boost/rpc/http/coroutine.hpp
// ~~~~~~~~~~~~~
//
// This file was modified from boost/asio/examples/http/server4 and its original
...
#ifndef BOOST_RPC_HTTP_COROUTINE_HPP
#define BOOST_RPC_HTTP_COROUTINE_HPP
